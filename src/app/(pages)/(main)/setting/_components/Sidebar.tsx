...
import { Settings, X, UserLock, BriefcaseBusiness, HatGlasses, Palette } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    { name: 'Password & Security', icon: UserLock, href: '/setting/security' },
    { name: 'Business', icon: BriefcaseBusiness, href: '/setting/business' },
    { name: 'Data & privacy', icon: HatGlasses, href: '/setting/data&privacy' },
    { name: 'AppearanceSettings', icon: Palette, href: '/setting/appearanceSettings' },
  ];
  ...
  return (
    <aside className={asideClasses} >
      <div className="flex items-center justify-end text-[var(--primary-text)]">
        {isMobile && (

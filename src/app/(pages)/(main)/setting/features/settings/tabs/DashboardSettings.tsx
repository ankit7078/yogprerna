...
import {CheckboxGroup, SelectGroup} from '../../../../../../../common/FormComponents';

const DashboardSettings = () => (
  <div className="space-y-12">
    <section>
      <h2 className="sub-heading font-semibold ">Dashboard Preferences</h2>
      <p className="mb-6 text-[var(--primary-text)]">Personalize your main dashboard</p>
    ...
    <section>
      <h2 className="sub-heading font-semibold">Widget Visibility</h2>
      <p className="text-[var(--primary-text)] mb-6">Choose which widgets to display</p>

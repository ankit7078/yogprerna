...
import { Award, GraduationCap, Star ,User } from 'lucide-react';
    ...
    >
      ...
      <div className="p-5 md:p-6 flex-1 flex flex-col">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-1 gap-2">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center space-x-1 ">
              <GraduationCap className="w-4 h-4  flex-shrink-0 text-[var(--text-hover-color)]" />
          ...
          <div className="flex items-center bg-[var(--warning-color-l)] px-3 py-1 space-x-1 rounded-custom self-start">
            <Star className="w-4 h-4 text-[var(--warning-color)]" />
            <p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 leading-relaxed flex-grow">
          <div className="flex items-center space-x-1">
            <Award className="w-4 h-4 mr-2 flex-shrink-0 text-[var(--text-hover-color)]" />
            <p>{institute?.accreditation || "N/A"}</p>
          </div>
          <div className="flex items-center space-x-1">
            <User className="w-4 h-4 flex-shrink-0 text-[var(--text-hover-color)]" />

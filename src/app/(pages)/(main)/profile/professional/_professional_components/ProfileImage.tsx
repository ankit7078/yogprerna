...
export default function ProfileImage({
  ...
  return (
    <div className="relative">
      <div className="h-40 w-40 rounded-2xl mt-2 bg-[var(--primary-icon-l)] overflow-hidden">
        {profileImage ? (
          ...
          <div className="h-full w-full bg-[var(--text-hover-color)] flex items-center justify-center">
